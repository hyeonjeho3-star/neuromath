    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          NeuroMath가 적용한 과학적 학습 원리와 효율적인 사용법
        </p>
      </div>
      ...
      <section className="mb-10">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2">
              {['1일', '3일', '1주', '2주', '1달', '3달'].map((interval, i) => (
                <div key={i} className="flex items-center">
                  <div className="px-3 py-2 bg-blue-500 text-white rounded-lg text-sm font-medium whitespace-nowrap">
                    {interval}
                  </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            NeuroMath는 <strong>최적의 난이도</strong>로 복습 시점을 조절합니다.
          </p>
      ...
      <section className="mb-10">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            NeuroMath는 <strong>FSRS (Free Spaced Repetition Scheduler) 4.5</strong> 알고리즘을 사용합니다.
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 text-sm">
                  <p className="text-gray-600 dark:text-gray-300">
                    <strong>예시:</strong> 피타고라스 정리를 외울 때 직각삼각형 그림을 떠올리고,
                    &quot;빗변의 제곱 = 두 변의 제곱의 합&quot;이라는 관계를 시각화하세요.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-center text-white">
        ...
        <p className="mb-4 opacity-90">
          과학적으로 검증된 방법으로 중학 수학 개념을 효율적으로 마스터하세요.
        </p>
        <a
          href="/study"
