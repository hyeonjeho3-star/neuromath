...
const SAMPLE_DECKS = [
  ...
  { name: '5주차 - 일차식의 덧셈과 뺄셈', file: '/decks/week05-linear-expressions.md' },
  { name: '6주차 - 등식과 일차방정식 기초', file: '/decks/week06-equations-basics.md' },
  { name: '7주차 - 복잡한 일차방정식', file: '/decks/week07-complex-equations.md' },
  { name: '8주차 - 일차방정식의 활용', file: '/decks/week08-equation-applications.md' },
  { name: '9주차 - 좌표평면과 사분면', file: '/decks/week09-coordinate-plane.md' },
  { name: '10주차 - 정비례와 반비례', file: '/decks/week10-proportions.md' },
  { name: '11주차 - 대수학 총정리', file: '/decks/week11-review-test.md' },
];

const TEMPLATES = [
  { name: 'Simple 형식 (단순)', file: '/samples/template-simple.md', desc: '앞면 | 뒷면 형식' },
];
      ...
      {importing && (
        <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <p className="text-blue-700 dark:text-blue-400 font-medium">덱 임포트 중...</p>
          </div>
        </div>
      )}
            ...
            <div className="space-y-2">
              {SAMPLE_DECKS.map((sample) => (
                <button
                  ...
                  disabled={importing}
                  className="w-full flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors text-left disabled:opacity-50"
                >
                ...
                >
                  ...
                  <div className="flex gap-6 text-sm">
                    ...
                    <div>
                      ...
                      <span className="font-medium text-blue-500">{stats?.dueToday ?? 0}</span>
                    </div>
                  </div>
